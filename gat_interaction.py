...
class GAT(torch.nn.Module):
    def __init__(self, n_output=1, num_features_pro=33, num_features_mol=78, output_dim=512, dropout=0.2, num_heads = 4):
       ...
       # self.mol_bn4 = nn.BatchNorm1d(num_features_mol * 4)
        ...
        self.pro_bn1 = nn.BatchNorm1d(num_features_pro* num_heads)
        self.pro_bn2 = nn.BatchNorm1d(num_features_pro * 2* num_heads)
        self.pro_bn3 = nn.BatchNorm1d(num_features_pro * 4* num_heads)
